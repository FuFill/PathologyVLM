...
def main() -> None:
    ...
    p.add_argument("--upload-s3", default="mil/vlm_patches/patch_registry_explain_siglip.csv")
    ...
    p.add_argument("--registry", required=True, help="full patch registry CSV")
    p.add_argument("--out", required=True, help="output filtered registry CSV")
    p.add_argument("--upload-s3", default="mil/vlm_patches/patch_registry_explain_gemma.csv")
